package cn.jiuzhou.file.common;

import java.io.Serializable;

/**
 * Created by jiuzhou on 2017/7/16.
 */
public class Result<W> implements Serializable {
    ...
    public static <W> Result<W> buildSuccess(String code,W obj) {
        return buildResult(true, code, "Success", obj);
    }

    public static <W> Result<W> buildSuccess(String code,String msg,W obj) {
